...
namespace eLearning
{
    public partial class Practise : Form
    {
        ...
        private void Practise_Load(object sender, EventArgs e)
        {
            ...
            Practise.quest_id = RandomNumber(4, 60000);
            Practise.answ1_id = Practise.quest_id;
            Practise.answ2_id = RandomNumber(3, 67000);
            Practise.answ3_id = RandomNumber(3, 65000);
            ...
            if (Practise.en_gr == 0)
            {
                ...
                while (reader2.Read())
                {
                    if (Practise.answ1_id == Convert.ToInt32(reader2["ID"]))
                    {
                        cor = reader2["Field2"].ToString();
                        label1.Text = reader2["Field1"].ToString();
                        Console.WriteLine("Correct Word:" + cor + "-----------");
                    }
                    if (Practise.answ2_id == Convert.ToInt32(reader2["ID"]))
                    {
                        fa1 = reader2["Field2"].ToString();
                    }
                    if (Practise.answ3_id == Convert.ToInt32(reader2["ID"]))
                    {
                        fa2 = reader2["Field2"].ToString();
                    }
                    //===================================
                    Practise.cor_answ = cor;
                    if (fail1 == 0)
                    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if ((groupBox1.Controls[0].Text.Equals(Practise.cor_answ)|| groupBox1.Controls[0].Text.Equals(" "+Practise.cor_answ)) && radioButton3.Checked)
            {
                
                new_cor = Practise.temp_cor + 1;
                Practise.temp_cor = new_cor;
            ...
            else if ((groupBox1.Controls[1].Text.Equals(Practise.cor_answ) || groupBox1.Controls[1].Text.Equals(" " + Practise.cor_answ)) && radioButton2.Checked)
            {
                new_cor = Practise.temp_cor + 1;
                Practise.temp_cor = new_cor;
                strSQL = "UPDATE Accounts123 SET Correct4=" + new_cor + " WHERE ID=" + startForm.temp_id;
            ...
            else if ((groupBox1.Controls[2].Text.Equals(Practise.cor_answ) || groupBox1.Controls[2].Text.Equals(" " + Practise.cor_answ)) && radioButton1.Checked)
            {
                new_cor = Practise.temp_cor + 1;
                Practise.temp_cor = new_cor;
                strSQL = "UPDATE Accounts123 SET Correct4=" + new_cor + " WHERE ID=" + startForm.temp_id;
            ...
            Console.WriteLine("Practise.cor_answ = _"+ Practise.cor_answ +"_");
